...
<html>
  ...
  <body>
    <div class="vertical-section-container centered">
      <h3>
        Import a document with an <code>&lt;iron-iconset-svg&gt;</code> to use the icons it contains with
        <code>&lt;iron-icon&gt;</code> elements in your page.
      </h3>
      <demo-snippet>
        <template>
      ...
      <h3>
        Use an inline <code>&lt;iron-iconset-svg&gt;</code> if you need to both define and use your icons in the same
        document.
      </h3>
      <demo-snippet>
        <template>
