...
<html>
  ...
  <body>
    ...
    <div class="vertical-section centered">
      ...
      The <code>value(s)</code> stored at <code>type="type1"</code> are:<br /><code><type-one></type-one></code
      >.<br /><br />The <code>value(s)</code> stored at <code>type="type2"</code> are:<br /><code
        ><type-two></type-two></code
      >.
    </div>
